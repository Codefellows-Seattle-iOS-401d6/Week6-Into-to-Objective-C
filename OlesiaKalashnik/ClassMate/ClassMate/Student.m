...
- (BOOL)isEqual:(Student *)student {
    return [self.name isEqualToString:student.name] && [self.surname isEqualToString:student.surname] &&  [self.phoneNumber isEqualToString:student.phoneNumber] &&  [self.email isEqualToString:student.email];
}
