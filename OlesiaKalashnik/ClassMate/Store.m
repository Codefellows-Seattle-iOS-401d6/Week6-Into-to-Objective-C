...
- (instancetype)init
{
    ...
    if (self) {
        NSArray* students = [NSKeyedUnarchiver unarchiveObjectWithData:[NSData dataWithContentsOfFile:[NSString archivePath]]];
        
        _students = students ? [[NSMutableArray alloc] initWithArray:students] : [NSMutableArray new];
    }
